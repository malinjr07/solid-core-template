...
## [Root-level layouts](https://docs.solidjs.com/solid-router/concepts/layouts#root-level-layouts)
...
## [Nested layouts](https://docs.solidjs.com/solid-router/concepts/layouts#nested-layouts)
