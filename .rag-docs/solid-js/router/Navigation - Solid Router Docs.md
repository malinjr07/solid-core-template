When using Solid Router, you can use the standard standard HTML [`<a>` elements](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/a), which triggers [soft navigation](https://docs.solidjs.com/solid-router/reference/components/a#soft-navigation). In addition to using this, Solid Router offers other options for navigating between routes:

-   The [`<A>` component](https://docs.solidjs.com/solid-router/reference/components/a).
-   The [`useNavigate` primitive](https://docs.solidjs.com/solid-router/reference/primitives/use-navigate).
-   The [`redirect` function](https://docs.solidjs.com/solid-router/reference/response-helpers/redirect).

___

## [`<A>` component](https://docs.solidjs.com/solid-router/concepts/navigation#a-component)
...
See the [`<A>` API reference](https://docs.solidjs.com/solid-router/reference/components/a) for more information.

### [Styling](https://docs.solidjs.com/solid-router/concepts/navigation#styling)
...
## [`useNavigate` primitive](https://docs.solidjs.com/solid-router/concepts/navigation#usenavigate-primitive)
...
See the [`useNavigate` API reference](https://docs.solidjs.com/solid-router/reference/primitives/use-navigate) for more information.

___

## [`redirect` function](https://docs.solidjs.com/solid-router/concepts/navigation#redirect-function)

The `redirect` function returns a [`Response` object](https://developer.mozilla.org/en-US/docs/Web/API/Response), which enables navigation to a specified route within [query](https://docs.solidjs.com/solid-router/reference/data-apis/query) or [action](https://docs.solidjs.com/solid-router/reference/data-apis/action).
...
See the [`redirect` API reference](https://docs.solidjs.com/solid-router/reference/response-helpers/redirect) for more information.