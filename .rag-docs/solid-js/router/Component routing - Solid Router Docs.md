...
To define routes using JSX, the [`Route`](https://docs.solidjs.com/solid-router/reference/components/route) is added to the [`<Router>`](https://docs.solidjs.com/solid-router/reference/components/router) component for each path you want to define:
