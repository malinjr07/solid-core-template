...
## [Accessing parameters](https://docs.solidjs.com/solid-router/concepts/path-parameters#accessing-parameters)

You can retrieve the values captured by parameters using [`useParams`](https://docs.solidjs.com/solid-router/reference/primitives/use-params).
...
## [Validating parameters](https://docs.solidjs.com/solid-router/concepts/path-parameters#validating-parameters)
...
## [Optional parameters](https://docs.solidjs.com/solid-router/concepts/path-parameters#optional-parameters)
...
## [Wildcard routes](https://docs.solidjs.com/solid-router/concepts/path-parameters#wildcard-routes)
