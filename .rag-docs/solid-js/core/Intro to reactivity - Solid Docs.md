...
## [Importance of reactivity](https://docs.solidjs.com/concepts/intro-to-reactivity#importance-of-reactivity)
...
[![](https://app.eraser.io/workspace/maDvFw5OryuPJOwSLyK9/preview?elements=cry9JT4nroFQ4rRxzOpvCg&type=embed)
...
](https://app.eraser.io/workspace/maDvFw5OryuPJOwSLyK9?elements=cry9JT4nroFQ4rRxzOpvCg&)

___

## [Reactive principles](https://docs.solidjs.com/concepts/intro-to-reactivity#reactive-principles)
...
[![](https://app.eraser.io/workspace/maDvFw5OryuPJOwSLyK9/preview?elements=lseAEjGlKLslaVsTlfej_g&type=embed)

![Open in Eraser](https://firebasestorage.googleapis.com/v0/b/second-petal-295822.appspot.com/o/images%2Fgithub%2FOpen%20in%20Eraser.svg?alt=media&token=968381c8-a7e7-472a-8ed6-4a6626da5501)

](https://app.eraser.io/workspace/maDvFw5OryuPJOwSLyK9?elements=lseAEjGlKLslaVsTlfej_g&)
...
## [State management](https://docs.solidjs.com/concepts/intro-to-reactivity#state-management)
...
Initialization, or creation is a **one-time event** that doesn't cause tracking. To track a signal, it must be accessed within the scope of a subscriber. Reactive primitives, such as [memos](https://docs.solidjs.com/concepts/derived-values/memos) can be used to create derived values from signals or other memos, and [effects](https://docs.solidjs.com/concepts/effects) to create subscribers that use the reactive graph output once it's settled.
...
## [Synchronous vs. asynchronous](https://docs.solidjs.com/concepts/intro-to-reactivity#synchronous-vs-asynchronous)
...
## [Key concepts](https://docs.solidjs.com/concepts/intro-to-reactivity#key-concepts)
