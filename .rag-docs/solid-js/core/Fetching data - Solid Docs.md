...
## [What is `createResource` ?](https://docs.solidjs.com/guides/fetching-data#what-is-createresource-)
...
## [Using `createResource`](https://docs.solidjs.com/guides/fetching-data#using-createresource)
...
## [Calling multiple async events](https://docs.solidjs.com/guides/fetching-data#calling-multiple-async-events)
...
[![](https://app.eraser.io/workspace/maDvFw5OryuPJOwSLyK9/preview?elements=kMt6qc0qF9MlG2K9P28pOQ&type=embed)
...
](https://app.eraser.io/workspace/maDvFw5OryuPJOwSLyK9?elements=kMt6qc0qF9MlG2K9P28pOQ&)

___

## [Dynamic data handling](https://docs.solidjs.com/guides/fetching-data#dynamic-data-handling)
