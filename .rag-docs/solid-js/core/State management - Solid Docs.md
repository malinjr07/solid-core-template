...
## [Managing basic state](https://docs.solidjs.com/guides/state-management#managing-basic-state)
...
## [Rendering state in the UI](https://docs.solidjs.com/guides/state-management#rendering-state-in-the-ui)
...
## [Reacting to changes](https://docs.solidjs.com/guides/state-management#reacting-to-changes)
...
## [Derived state](https://docs.solidjs.com/guides/state-management#derived-state)
...
## [Lifting state](https://docs.solidjs.com/guides/state-management#lifting-state)
...
## [Managing complex state](https://docs.solidjs.com/guides/state-management#managing-complex-state)
