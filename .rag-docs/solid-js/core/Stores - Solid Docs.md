Stores are a state management primitive that provide a centralized way to handle shared data and reduce redundancy. Unlike [signals](https://docs.solidjs.com/concepts/signals), which track a single value and trigger a full re-render when updated, stores maintain fine-grained reactivity by updating only the properties that change. They can produce a collection of reactive signals, each linked to an individual property, making them well-suited for managing complex state efficiently.

___

## [Creating a store](https://docs.solidjs.com/concepts/stores#creating-a-store)
...
## [Accessing store values](https://docs.solidjs.com/concepts/stores#accessing-store-values)
...
## [Modifying store values](https://docs.solidjs.com/concepts/stores#modifying-store-values)
...
## [Path syntax flexibility](https://docs.solidjs.com/concepts/stores#path-syntax-flexibility)
...
[![](https://app.eraser.io/workspace/maDvFw5OryuPJOwSLyK9/preview?elements=M6Y55ScNFDD_2HmRd4OJkQ&type=embed)
...
](https://app.eraser.io/workspace/maDvFw5OryuPJOwSLyK9?elements=M6Y55ScNFDD_2HmRd4OJkQ&)
...
## [Modifying values in arrays](https://docs.solidjs.com/concepts/stores#modifying-values-in-arrays)
...
### [Modifying multiple elements](https://docs.solidjs.com/concepts/stores#modifying-multiple-elements)
...
Multi-setter syntax differs from the "equivalent" code in one key way: a single store setter call automatically gets wrapped in a [`batch`](https://docs.solidjs.com/reference/reactive-utilities/batch), so all the elements update at once before any downstream effects are triggered.
...
## [Modifying objects](https://docs.solidjs.com/concepts/stores#modifying-objects)
...
## [Store utilities](https://docs.solidjs.com/concepts/stores#store-utilities)
