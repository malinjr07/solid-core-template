...
## [Introducing stores](https://docs.solidjs.com/guides/complex-state-management#introducing-stores)
...
## [Creating a store](https://docs.solidjs.com/guides/complex-state-management#creating-a-store)
...
## [Accessing state values](https://docs.solidjs.com/guides/complex-state-management#accessing-state-values)
...
## [Making changes to the store](https://docs.solidjs.com/guides/complex-state-management#making-changes-to-the-store)
...
## [State sharing](https://docs.solidjs.com/guides/complex-state-management#state-sharing)
