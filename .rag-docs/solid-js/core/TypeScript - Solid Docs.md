...
## [Configuring TypeScript](https://docs.solidjs.com/configuration/typescript#configuring-typescript)
...
## [Migrating from JavaScript to TypeScript](https://docs.solidjs.com/configuration/typescript#migrating-from-javascript-to-typescript)
...
## [API types](https://docs.solidjs.com/configuration/typescript#api-types)
...
### [Event handling](https://docs.solidjs.com/configuration/typescript#event-handling)
...
## [Control flow-based narrowing](https://docs.solidjs.com/configuration/typescript#control-flow-based-narrowing)
...
## [Advanced JSX attributes and directives](https://docs.solidjs.com/configuration/typescript#advanced-jsx-attributes-and-directives)
