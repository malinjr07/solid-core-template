...
## [How sessions work](https://docs.solidjs.com/solid-start/advanced/session#how-sessions-work)
...
Most of these steps are automatically managed by the [session helpers](https://docs.solidjs.com/solid-start/advanced/session#session-helpers).

### [Database sessions](https://docs.solidjs.com/solid-start/advanced/session#database-sessions)
...
## [Session helpers](https://docs.solidjs.com/solid-start/advanced/session#session-helpers)
...
## [Creating a session](https://docs.solidjs.com/solid-start/advanced/session#creating-a-session)
...
## [Getting the session data](https://docs.solidjs.com/solid-start/advanced/session#getting-the-session-data)
...
## [Updating the session data](https://docs.solidjs.com/solid-start/advanced/session#updating-the-session-data)
...
## [Clearing the session data](https://docs.solidjs.com/solid-start/advanced/session#clearing-the-session-data)
