...
## [Writing an API route](https://docs.solidjs.com/solid-start/building-your-application/api-routes#writing-an-api-route)
...
## [Session management](https://docs.solidjs.com/solid-start/building-your-application/api-routes#session-management)
...
## [Exposing a GraphQL API](https://docs.solidjs.com/solid-start/building-your-application/api-routes#exposing-a-graphql-api)
...
## [Exposing a tRPC server route](https://docs.solidjs.com/solid-start/building-your-application/api-routes#exposing-a-trpc-server-route)
