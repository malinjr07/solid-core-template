...
-   **[API routes](https://docs.solidjs.com/solid-start/building-your-application/api-routes)** — define the serverless functions in your app

To read more about API routes, [see the API Routes section.](https://docs.solidjs.com/solid-start/building-your-application/api-routes)

___

## [Creating new routes](https://docs.solidjs.com/solid-start/building-your-application/routing#creating-new-routes)
...
## [File based routing](https://docs.solidjs.com/solid-start/building-your-application/routing#file-based-routing)
...
### [Nested routes](https://docs.solidjs.com/solid-start/building-your-application/routing#nested-routes)
...
### [Nested layouts](https://docs.solidjs.com/solid-start/building-your-application/routing#nested-layouts)
...
## [Renaming Index](https://docs.solidjs.com/solid-start/building-your-application/routing#renaming-index)
...
#### [Escaping nested routes](https://docs.solidjs.com/solid-start/building-your-application/routing#escaping-nested-routes)
...
### [Dynamic routes](https://docs.solidjs.com/solid-start/building-your-application/routing#dynamic-routes)
...
#### [Optional parameter](https://docs.solidjs.com/solid-start/building-your-application/routing#optional-parameter)
...
#### [Catch-all routes](https://docs.solidjs.com/solid-start/building-your-application/routing#catch-all-routes)
...
## [Route groups](https://docs.solidjs.com/solid-start/building-your-application/routing#route-groups)
...
## [Additional route config](https://docs.solidjs.com/solid-start/building-your-application/routing#additional-route-config)
