...
```vbnet
◆  Which template would you like to use?│  ● basic│  ○ bare│  ○ with-solidbase│  ○ with-auth│  ○ with-authjs│  ○ with-drizzle│  ○ with-mdx│  ○ with-prisma│  ○ with-solid-styled│  ○ with-tailwindcss│  ...└
```
...
## [Project files](https://docs.solidjs.com/solid-start/getting-started#project-files)
