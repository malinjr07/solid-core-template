...
## [Common use cases](https://docs.solidjs.com/solid-start/advanced/middleware#common-use-cases)
...
## [Limitations](https://docs.solidjs.com/solid-start/advanced/middleware#limitations)
...
## [Basic usage](https://docs.solidjs.com/solid-start/advanced/middleware#basic-usage)

Middleware is configured by exporting a configuration object from a dedicated file (e.g., `src/middleware/index.ts`). This object, created using the [`createMiddleware`](https://docs.solidjs.com/solid-start/reference/server/create-middleware) function, defines when middleware functions execute throughout the request lifecycle.
...
## [Lifecycle events](https://docs.solidjs.com/solid-start/advanced/middleware#lifecycle-events)
...
### [`onRequest`](https://docs.solidjs.com/solid-start/advanced/middleware#onrequest)
...
### [`onBeforeResponse`](https://docs.solidjs.com/solid-start/advanced/middleware#onbeforeresponse)
...
## [Locals](https://docs.solidjs.com/solid-start/advanced/middleware#locals)
...
Within middleware, `event.locals` can be accessed and modified directly. Other server-side contexts must use the [`getRequestEvent`](https://docs.solidjs.com/reference/server-utilities/get-request-event) function to access the `event.locals` object.
...
## [Cookies](https://docs.solidjs.com/solid-start/advanced/middleware#cookies)
...
## [Custom responses](https://docs.solidjs.com/solid-start/advanced/middleware#custom-responses)
...
### [Redirects](https://docs.solidjs.com/solid-start/advanced/middleware#redirects)

[Solid Router](https://docs.solidjs.com/solid-router) provides the [`redirect` helper function](https://docs.solidjs.com/solid-router/reference/response-helpers/redirect) which simplifies creating redirect responses.
...
### [JSON responses](https://docs.solidjs.com/solid-start/advanced/middleware#json-responses)

Solid Router provides the [`json` helper function](https://docs.solidjs.com/solid-router/reference/response-helpers/json) which simplifies sending custom JSON responses.
...
## [Chaining middleware functions](https://docs.solidjs.com/solid-start/advanced/middleware#chaining-middleware-functions)
