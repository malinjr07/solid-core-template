...
](https://tanstack.com/router/latest/docs/framework/solid/decisions-on-dx#tanstack-routers-origin-story)
...
](https://tanstack.com/router/latest/docs/framework/solid/decisions-on-dx#how-does-tanstack-router-achieve-this)
...
1.  [**Route configuration boilerplate?**](https://tanstack.com/router/latest/docs/framework/solid/decisions-on-dx#why-is-the-routers-configuration-done-this-way): You have to define your routes in a way that allows TypeScript to infer the types of your routes as much as possible.
2.  [**TypeScript module declaration for the router?**](https://tanstack.com/router/latest/docs/framework/solid/decisions-on-dx#declaring-the-router-instance-for-type-inference): You have to pass the Router instance to the rest of your application using TypeScript's module declaration.
3.  [**Why push for file-based routing over code-based?**](https://tanstack.com/router/latest/docs/framework/solid/decisions-on-dx#why-is-file-based-routing-the-preferred-way-to-define-routes): We push for file-based routing as the preferred way to define your routes.
...
](https://tanstack.com/router/latest/docs/framework/solid/decisions-on-dx#why-is-the-routers-configuration-done-this-way)
...
You can read more about [code-based routing](https://tanstack.com/router/latest/docs/framework/solid/routing/code-based-routing) to see how to define your routes in this way.

Finding Code-based routing to be a bit too cumbersome? See why [file-based routing](https://tanstack.com/router/latest/docs/framework/solid/decisions-on-dx#why-is-file-based-routing-the-preferred-way-to-define-routes) is the preferred way to define your routes.

[

## Declaring the Router instance for type inference

](https://tanstack.com/router/latest/docs/framework/solid/decisions-on-dx#declaring-the-router-instance-for-type-inference)
...
](https://tanstack.com/router/latest/docs/framework/solid/decisions-on-dx#why-is-file-based-routing-the-preferred-way-to-define-routes)
...
Check out the guides for [file-based routing](https://tanstack.com/router/latest/docs/framework/solid/routing/file-based-routing) and [code-splitting](https://tanstack.com/router/latest/docs/framework/solid/guide/code-splitting) for a more in-depth explanation of how they work in TanStack Router.