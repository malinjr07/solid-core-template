...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-mutations#invalidating-tanstack-router-after-a-mutation)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-mutations#long-term-mutation-state)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-mutations#using-mutation-keys)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-mutations#using-the-routersubscribe-method)
