...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#everything-is-relative)
...
[](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#shared-navigation-api)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#tooptions-interface)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#navigateoptions-interface)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#linkoptions-interface)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#navigation-api)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#link-component)
...
In addition to the [LinkOptions](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#linkoptions-interface) interface, the Link component also supports the following props:
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#absolute-links)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#dynamic-links)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#relative-links)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#special-relative-paths--and-)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#search-param-links)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#search-param-type-safety)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#hash-links)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#navigating-with-optional-parameters)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#parameter-inheritance-vs-removal)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#basic-optional-parameter-navigation)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#function-style-parameter-updates)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#multiple-optional-parameters)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#mixed-required-and-optional-parameters)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#advanced-optional-parameter-patterns)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#navigation-with-search-params-and-optional-parameters)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#imperative-navigation-with-optional-parameters)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#active--inactive-props)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#the-data-status-attribute)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#active-options)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#passing-isactive-to-children)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#link-preloading)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#link-preloading-delay)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#usenavigate)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#navigate-options)

The navigate function returned by useNavigate accepts the [NavigateOptions interface](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#navigateoptions-interface)

[

## Navigate Component

](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#navigate-component)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#routernavigate)

The router.navigate method is the same as the navigate function returned by useNavigate and accepts the same [NavigateOptions interface](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#navigateoptions-interface). Unlike the useNavigate hook, it is available anywhere your router instance is available and is thus a great way to navigate imperatively from anywhere in your application, including outside of your framework.

[

## useMatchRoute and <MatchRoute>

](https://tanstack.com/router/latest/docs/framework/solid/guide/navigation#usematchroute-and-matchroute)
