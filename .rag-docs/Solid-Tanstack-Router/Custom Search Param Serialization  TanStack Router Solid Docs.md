...
](https://tanstack.com/router/latest/docs/framework/solid/guide/custom-search-param-serialization#using-base64)
...
> [⚠️ Why does this snippet not use atob/btoa?](https://tanstack.com/router/latest/docs/framework/solid/guide/custom-search-param-serialization#safe-binary-encodingdecoding)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/custom-search-param-serialization#using-the-query-string-library)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/custom-search-param-serialization#using-the-jsurl2-library)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/custom-search-param-serialization#using-the-zipson-library)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/custom-search-param-serialization#safe-binary-encodingdecoding)
