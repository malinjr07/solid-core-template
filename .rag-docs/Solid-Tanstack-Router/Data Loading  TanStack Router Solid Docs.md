...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#the-route-loading-lifecycle)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#to-router-cache-or-not-to-router-cache)
...
If you know right away that you'd like to or need to use something more robust like TanStack Query, skip to the [External Data Loading](https://tanstack.com/router/latest/docs/framework/solid/guide/external-data-loading) guide.

[

## Using the Router Cache

](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#using-the-router-cache)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#route-loaders)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#loader-parameters)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#consuming-data-from-loaders)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#dependency-based-stale-while-revalidate-caching)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#key-options)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#%EF%B8%8F-some-important-defaults)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#using-loaderdeps-to-access-search-params)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#using-staletime-to-control-how-long-data-is-considered-fresh)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#turning-off-stale-while-revalidate-caching)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#using-shouldreload-and-gctime-to-opt-out-of-caching)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#opting-out-of-caching-while-still-preloading)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#passing-all-loader-events-to-an-external-cache)

We break down this use case in the [External Data Loading](https://tanstack.com/router/latest/docs/framework/solid/guide/external-data-loading) page, but if you'd like to use an external cache like TanStack Query, you can do so by passing all loader events to your external cache. As long as you are using the defaults, the only change you'll need to make is to set the defaultPreloadStaleTime option on the router to 0:
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#using-router-context)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#using-path-params)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#using-route-context)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#using-search-params-in-loaders)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#accessing-search-params-via-routeoptionsloaderdeps)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#using-the-abort-signal)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#using-the-preload-flag)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#handling-slow-loaders)
...
-   Split up your fast and slow data into separate promises and defer the slow data until after the fast data is loaded (see the [Deferred Data Loading](https://tanstack.com/router/latest/docs/framework/solid/guide/deferred-data-loading) guide).
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#showing-a-pending-component)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#avoiding-pending-component-flash)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#handling-errors)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#handling-errors-with-routeoptionsonerror)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#handling-errors-with-routeoptionsoncatch)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#handling-errors-with-routeoptionserrorcomponent)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#using-the-default-errorcomponent)
