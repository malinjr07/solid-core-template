...
](https://tanstack.com/router/latest/docs/framework/solid/guide/code-splitting#how-does-tanstack-router-split-code)
...
>     
>     Knowing the disadvantages of splitting the loader, if you still want to go ahead with it, head over to the [Data Loader Splitting](https://tanstack.com/router/latest/docs/framework/solid/guide/code-splitting#data-loader-splitting) section.
>     
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/code-splitting#encapsulating-a-routes-files-into-a-directory)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/code-splitting#approaches-to-code-splitting)

TanStack Router supports multiple approaches to code splitting. If you are using code-based routing, skip to the [Code-Based Splitting](https://tanstack.com/router/latest/docs/framework/solid/guide/code-splitting#code-based-splitting) section.

When you are using file-based routing, you can use the following approaches to code splitting:

-   [Using automatic code-splitting ✨](https://tanstack.com/router/latest/docs/framework/solid/guide/code-splitting#using-automatic-code-splitting)
-   [Using the .lazy.tsx suffix](https://tanstack.com/router/latest/docs/framework/solid/guide/code-splitting#using-the-lazytsx-suffix)
-   [Using Virtual Routes](https://tanstack.com/router/latest/docs/framework/solid/guide/code-splitting#using-virtual-routes)

[

## Using automatic code-splitting✨

](https://tanstack.com/router/latest/docs/framework/solid/guide/code-splitting#using-automatic-code-splitting)
...
The automatic code-splitting feature is **ONLY** available when you are using file-based routing with one of our [supported bundlers](https://tanstack.com/router/latest/docs/framework/solid/routing/file-based-routing#getting-started-with-file-based-routing). This will **NOT** work if you are **only** using the CLI (@tanstack/router-cli).
...
If you want more control over the code-splitting process, head over to the [Automatic Code Splitting](https://tanstack.com/router/latest/docs/framework/solid/guide/automatic-code-splitting) guide to learn more about the options available.

[

## Using the .lazy.tsx suffix

](https://tanstack.com/router/latest/docs/framework/solid/guide/code-splitting#using-the-lazytsx-suffix)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/code-splitting#example-code-splitting-with-lazytsx)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/code-splitting#using-virtual-routes)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/code-splitting#code-based-splitting)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/code-splitting#data-loader-splitting)

**Be warned!!!** Splitting a route loader is a dangerous game.

It can be a powerful tool to reduce bundle size, but it comes with a cost as mentioned in the [How does TanStack Router split code?](https://tanstack.com/router/latest/docs/framework/solid/guide/code-splitting#how-does-tanstack-router-split-code) section.
...
If you are using file-based routing, you'll only be able to split your loader if you are using [Automatic Code Splitting](https://tanstack.com/router/latest/docs/framework/solid/guide/code-splitting#using-automatic-code-splitting) with customized bundling options.

[

## Manually accessing Route APIs in other files with the getRouteApi helper

](https://tanstack.com/router/latest/docs/framework/solid/guide/code-splitting#manually-accessing-route-apis-in-other-files-with-the-getrouteapi-helper)
