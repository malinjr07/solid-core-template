...
](https://tanstack.com/router/latest/docs/framework/solid/installation/with-vite#ignoring-the-generated-route-tree-file)
...
](https://tanstack.com/router/latest/docs/framework/solid/installation/with-vite#configuration)
