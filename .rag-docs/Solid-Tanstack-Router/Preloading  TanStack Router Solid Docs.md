...
](https://tanstack.com/router/latest/docs/framework/solid/guide/preloading#supported-preloading-strategies)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/preloading#how-long-does-preloaded-data-stay-in-memory)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/preloading#preload-delay)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/preloading#built-in-preloading--preloadstaletime)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/preloading#preloading-with-external-libraries)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/preloading#preloading-manually)
