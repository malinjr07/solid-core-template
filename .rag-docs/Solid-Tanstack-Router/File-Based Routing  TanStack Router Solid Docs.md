Most of the TanStack Router documentation is written for file-based routing and is intended to help you understand in more detail how to configure file-based routing and the technical details behind how it works. While file-based routing is the preferred and recommended way to configure TanStack Router, you can also use [code-based routing](https://tanstack.com/router/latest/docs/framework/solid/routing/code-based-routing) if you prefer.

[

## What is File-Based Routing?

](https://tanstack.com/router/latest/docs/framework/solid/routing/file-based-routing#what-is-file-based-routing)
...
](https://tanstack.com/router/latest/docs/framework/solid/routing/file-based-routing#s-or-s)
...
](https://tanstack.com/router/latest/docs/framework/solid/routing/file-based-routing#directory-routes)
...
](https://tanstack.com/router/latest/docs/framework/solid/routing/file-based-routing#flat-routes)
...
|   ʦ posts\_.$postId.edit.tsx   |   /posts/$postId/edit   |        <Root><EditPost>         |
|         ʦ settings.tsx         |        /settings        |        <Root><Settings>         |
...
](https://tanstack.com/router/latest/docs/framework/solid/routing/file-based-routing#mixed-flat-and-directory-routes)
...
If you find that the default file-based routing structure doesn't fit your needs, you can always use [Virtual File Routes](https://tanstack.com/router/latest/docs/framework/solid/routing/virtual-file-routes) to control the source of your routes whilst still getting the awesome performance benefits of file-based routing.

[

## Getting started with File-Based Routing

](https://tanstack.com/router/latest/docs/framework/solid/routing/file-based-routing#getting-started-with-file-based-routing)
...
-   [Configuration with Vite](https://tanstack.com/router/latest/docs/framework/solid/routing/file-based-routing#configuration-with-vite)
