...
You shouldn't forget to _ignore_ the generated route tree file. Head over to the [Ignoring the generated route tree file](https://tanstack.com/router/latest/docs/framework/solid/installation/with-router-cli#ignoring-the-generated-route-tree-file) section to learn more.
...
](https://tanstack.com/router/latest/docs/framework/solid/installation/with-router-cli#using-the-generate-command)
...
](https://tanstack.com/router/latest/docs/framework/solid/installation/with-router-cli#using-the-watch-command)
...
](https://tanstack.com/router/latest/docs/framework/solid/installation/with-router-cli#ignoring-the-generated-route-tree-file)
...
](https://tanstack.com/router/latest/docs/framework/solid/installation/with-router-cli#configuration)
...
You can find all the available configuration options in the [File-based Routing API Reference](https://tanstack.com/router/latest/docs/api/file-based-routing).