...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#path-params-can-be-used-by-child-routes)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#path-params-in-loaders)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#path-params-in-components)
...
> 🧠 Quick tip: If your component is code-split, you can use the [getRouteApi function](https://tanstack.com/router/latest/docs/framework/solid/guide/code-splitting#manually-accessing-route-apis-in-other-files-with-the-getrouteapi-helper) to avoid having to import the Route configuration to get access to the typed useParams() hook.

[

## Path Params outside of Routes

](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#path-params-outside-of-routes)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#navigating-with-path-params)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#prefixes-and-suffixes-for-path-params)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#defining-prefixes)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#defining-suffixes)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#combining-prefixes-and-suffixes)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#optional-path-parameters)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#defining-optional-parameters)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#how-optional-parameters-work)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#accessing-optional-parameters)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#optional-parameters-in-loaders)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#optional-parameters-in-beforeload)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#advanced-optional-parameter-patterns)[

#### With Prefix and Suffix

](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#with-prefix-and-suffix)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#all-optional-parameters)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#optional-parameters-with-wildcards)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#navigating-with-optional-parameters)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#type-safety-with-optional-parameters)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#internationalization-i18n-with-optional-path-parameters)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#prefix-based-i18n)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#complex-i18n-patterns)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#language-navigation)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#advanced-i18n-with-optional-parameters)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#seo-and-canonical-urls)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#type-safety-for-i18n)
...
<Link to="/shop/{-$category}" params={{ params().category }}>
View in English
</Link>
)}
</div>
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/path-params#allowed-characters)
