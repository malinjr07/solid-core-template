...
](https://tanstack.com/router/latest/docs/framework/solid/guide/link-options#using-linkoptions-function-to-create-re-usable-options)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/link-options#an-array-of-linkoptions)
