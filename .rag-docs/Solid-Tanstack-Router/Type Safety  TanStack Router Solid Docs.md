...
](https://tanstack.com/router/latest/docs/framework/solid/guide/type-safety#route-definitions)[

### File-based Routing

](https://tanstack.com/router/latest/docs/framework/solid/guide/type-safety#file-based-routing)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/type-safety#code-based-routing)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/type-safety#exported-hooks-components-and-utilities)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/type-safety#fixing-the-component-context-problem)
...
> 🧠 Quick tip: If your component is code-split, you can use the [getRouteApi function](https://tanstack.com/router/latest/docs/framework/solid/guide/code-splitting#manually-accessing-route-apis-in-other-files-with-the-getrouteapi-helper) to avoid having to pass in the Route.fullPath to get access to the typed useParams() and useSearch() hooks.

[

### What if I don't know the route? What if it's a shared component?

](https://tanstack.com/router/latest/docs/framework/solid/guide/type-safety#what-if-i-dont-know-the-route-what-if-its-a-shared-component)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/type-safety#what-if-i-pass-the-wrong-from-path)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/type-safety#what-if-i-dont-know-the-route-or-its-a-shared-component-and-i-cant-pass-from)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/type-safety#router-context)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/type-safety#performance-recommendations)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/type-safety#only-infer-types-you-need)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/type-safety#narrow-to-relevant-routes-as-much-as-you-possibly-can)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/type-safety#consider-using-the-object-syntax-of-addchildren)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/type-safety#avoid-internal-types-without-narrowing)
