...
](https://tanstack.com/router/latest/docs/framework/solid/guide/creating-a-router#the-router-class)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/creating-a-router#route-tree)
...
Whether you used [file-based routing](https://tanstack.com/router/latest/docs/framework/solid/routing/file-based-routing) or [code-based routing](https://tanstack.com/router/latest/docs/framework/solid/routing/code-based-routing), you'll need to pass your route tree to the createRouter function:

[

### Filesystem Route Tree

](https://tanstack.com/router/latest/docs/framework/solid/guide/creating-a-router#filesystem-route-tree)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/creating-a-router#code-based-route-tree)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/creating-a-router#404-not-found-route)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/creating-a-router#other-options)

There are many other options that can be passed to the Router constructor. You can find a full list of them in the [API Reference](https://tanstack.com/router/latest/docs/framework/solid/api/router/RouterOptionsType).