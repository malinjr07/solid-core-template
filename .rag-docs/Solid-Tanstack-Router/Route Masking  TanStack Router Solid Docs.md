...
Each of these scenarios can be achieved with route masking and even extended to support more advanced patterns like [parallel routes](https://tanstack.com/router/latest/docs/framework/solid/guide/parallel-routes).

[

## How does route masking work?

](https://tanstack.com/router/latest/docs/framework/solid/guide/route-masking#how-does-route-masking-work)

You **do not** need to understand how route masking works in order to use it. This section is for those who are curious about how it works under the hood. Skip to [How do I use route masking?](https://tanstack.com/router/latest/docs/framework/solid/guide/route-masking#how-do-i-use-route-masking) to learn how to use it!.
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/route-masking#how-do-i-use-route-masking)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/route-masking#imperative-route-masking)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/route-masking#declarative-route-masking)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/route-masking#unmasking-when-sharing-the-url)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/route-masking#local-unmasking-defaults)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/route-masking#unmasking-on-page-reload)
