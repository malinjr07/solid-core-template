...
](https://tanstack.com/router/latest/docs/framework/solid/overview#a-fork-in-the-route)
...
](https://tanstack.com/router/latest/docs/framework/solid/overview#why-tanstack-router)
...
](https://tanstack.com/router/latest/docs/framework/solid/overview#100-inferred-typescript-support)
...
](https://tanstack.com/router/latest/docs/framework/solid/overview#1st-class-search-parameters)
...
](https://tanstack.com/router/latest/docs/framework/solid/overview#built-in-caching-and-friendly-data-loading)
...
](https://tanstack.com/router/latest/docs/framework/solid/overview#built-in-cache)
...
](https://tanstack.com/router/latest/docs/framework/solid/overview#flexible--powerful-data-lifecycle-apis)
...
](https://tanstack.com/router/latest/docs/framework/solid/overview#inherited-route-context)
...
](https://tanstack.com/router/latest/docs/framework/solid/overview#file-based-andor-code-based-routing)
...
](https://tanstack.com/router/latest/docs/framework/solid/overview#acknowledgements)
...
](https://tanstack.com/router/latest/docs/framework/solid/overview#lets-go)
