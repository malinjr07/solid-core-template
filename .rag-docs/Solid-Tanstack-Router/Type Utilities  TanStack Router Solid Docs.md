...
](https://tanstack.com/router/latest/docs/framework/solid/guide/type-utilities#type-checking-an-array-of-link-options-with-validatelinkoptionsarray)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/type-utilities#type-checking-redirect-options-with-validateredirectoptions)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/type-utilities#type-checking-navigate-options-with-validatenavigateoptions)
