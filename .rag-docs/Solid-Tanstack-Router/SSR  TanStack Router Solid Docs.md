...
](https://tanstack.com/router/latest/docs/framework/solid/guide/ssr#non-streaming-ssr)
...
-   And, either:
    -   defaultRenderHandler from @tanstack/solid-router
        -   This will render your application in your server entry and also automatically handle application-level hydration/dehydration and also automatically implement the RouterServer component. or:
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/ssr#automatic-server-history)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/ssr#automatic-loader-dehydrationhydration)
...
⚠️ If you are using deferred data streaming, you will also need to ensure that you have implemented the [SSR Streaming & Stream Transform](https://tanstack.com/router/latest/docs/framework/solid/guide/ssr#streaming-ssr) pattern near the end of this guide.

For more information on how to utilize data loading, see the [Data Loading](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading) guide.

[

### Router Creation

](https://tanstack.com/router/latest/docs/framework/solid/guide/ssr#router-creation)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/ssr#rendering-the-application-on-the-server)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/ssr#rendering-the-application-on-the-client)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/ssr#streaming-ssr)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/ssr#streaming-dehydrationhydration)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/ssr#data-serialization)
