...
](https://tanstack.com/router/latest/docs/framework/solid/guide/search-params#why-not-just-use-urlsearchparams)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/search-params#search-params-the-og-state-manager)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/search-params#json-first-search-params)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/search-params#validating-and-typing-search-params)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/search-params#enter-validation--typescript)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/search-params#validating-search-params)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/search-params#adapters)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/search-params#zod)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/search-params#valibot)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/search-params#arktype)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/search-params#effectschema)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/search-params#reading-search-params)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/search-params#using-search-params-in-loaders)

Please read the [Search Params in Loaders](https://tanstack.com/router/latest/docs/framework/solid/guide/data-loading#using-loaderdeps-to-access-search-params) section for more information about how to read search params in loaders with the loaderDeps option.

[

### Search Params are inherited from Parent Routes

](https://tanstack.com/router/latest/docs/framework/solid/guide/search-params#search-params-are-inherited-from-parent-routes)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/search-params#search-params-in-components)
...
If your component is code-split, you can use the [getRouteApi function](https://tanstack.com/router/latest/docs/framework/solid/guide/code-splitting#manually-accessing-route-apis-in-other-files-with-the-getrouteapi-helper) to avoid having to import the Route configuration to get access to the typed useSearch() hook.

[

### Search Params outside of Route Components

](https://tanstack.com/router/latest/docs/framework/solid/guide/search-params#search-params-outside-of-route-components)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/search-params#writing-search-params)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/search-params#link-search-)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/search-params#usenavigate-navigate-search-)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/search-params#routernavigate-search-)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/search-params#navigate-search-)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/search-params#transforming-search-with-search-middlewares)
