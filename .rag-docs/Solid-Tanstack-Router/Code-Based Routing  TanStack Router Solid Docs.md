Code-based routing is not recommended for most applications. It is recommended to use [File-Based Routing](https://tanstack.com/router/latest/docs/framework/solid/routing/file-based-routing) instead.

[

## ⚠️ Before You Start

](https://tanstack.com/router/latest/docs/framework/solid/routing/code-based-routing#%EF%B8%8F-before-you-start)

-   If you're using [File-Based Routing](https://tanstack.com/router/latest/docs/framework/solid/routing/file-based-routing), **skip this guide**.
-   If you still insist on using code-based routing, you must read the [Routing Concepts](https://tanstack.com/router/latest/docs/framework/solid/routing/routing-concepts) guide first, as it also covers core concepts of the router.

[

## Route Trees

](https://tanstack.com/router/latest/docs/framework/solid/routing/code-based-routing#route-trees)
...
Let's consider the same route tree from the [Route Trees & Nesting](https://tanstack.com/router/latest/docs/framework/solid/routing/route-trees#route-trees) guide, and convert it to code-based routing:
...
](https://tanstack.com/router/latest/docs/framework/solid/routing/code-based-routing#anatomy-of-a-route)
...
](https://tanstack.com/router/latest/docs/framework/solid/routing/code-based-routing#manually-building-the-route-tree)
...
](https://tanstack.com/router/latest/docs/framework/solid/routing/code-based-routing#routing-concepts-for-code-based-routing)
...
We're going to assume you've read the [Routing Concepts](https://tanstack.com/router/latest/docs/framework/solid/routing/routing-concepts) guide and are familiar with each of these main concepts:
...
](https://tanstack.com/router/latest/docs/framework/solid/routing/code-based-routing#the-root-route)
...
To learn more about Context in TanStack Router, see the [Router Context](https://tanstack.com/router/latest/docs/framework/solid/guide/router-context) guide.

[

## Basic Routes

](https://tanstack.com/router/latest/docs/framework/solid/routing/code-based-routing#basic-routes)
...
](https://tanstack.com/router/latest/docs/framework/solid/routing/code-based-routing#index-routes)
...
](https://tanstack.com/router/latest/docs/framework/solid/routing/code-based-routing#dynamic-route-segments)
...
If your component is code-split, you can use the [getRouteApi function](https://tanstack.com/router/latest/docs/framework/solid/guide/code-splitting#manually-accessing-route-apis-in-other-files-with-the-getrouteapi-helper) to avoid having to import the postIdRoute configuration to get access to the typed useParams() hook.

[

## Splat / Catch-All Routes

](https://tanstack.com/router/latest/docs/framework/solid/routing/code-based-routing#splat--catch-all-routes)
...
](https://tanstack.com/router/latest/docs/framework/solid/routing/code-based-routing#layout-routes)
...
](https://tanstack.com/router/latest/docs/framework/solid/routing/code-based-routing#pathless-layout-routes)
...
](https://tanstack.com/router/latest/docs/framework/solid/routing/code-based-routing#non-nested-routes)
