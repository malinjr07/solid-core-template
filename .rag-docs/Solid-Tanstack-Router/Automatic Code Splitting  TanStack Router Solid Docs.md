...
](https://tanstack.com/router/latest/docs/framework/solid/guide/automatic-code-splitting#how-does-it-work)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/automatic-code-splitting#the-transformation-process)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/automatic-code-splitting#what-gets-code-split)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/automatic-code-splitting#rules-of-splitting)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/automatic-code-splitting#do-not-export-route-properties)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/automatic-code-splitting#granular-control)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/automatic-code-splitting#global-code-splitting-behavior-defaultbehavior)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/automatic-code-splitting#advanced-programmatic-control-splitbehavior)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/automatic-code-splitting#per-route-overrides-codesplitgroupings)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/automatic-code-splitting#configuration-order-matters)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/automatic-code-splitting#splitting-the-data-loader)
