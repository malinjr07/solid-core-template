Document head management is the process of managing the head, title, meta, link, and script tags of a document and TanStack Router provides a robust way to manage the document head for full-stack applications that use Start and for single-page applications that use @tanstack/solid-router. It provides:
...
For full-stack applications that use Start, and even for single-page applications that use @tanstack/solid-router, managing the document head is a crucial part of any application for the following reasons:
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/document-head-management#managing-the-document-head)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/document-head-management#deduping)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/document-head-management#headcontent-)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/document-head-management#startfull-stack-applications)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/document-head-management#single-page-applications)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/document-head-management#managing-body-scripts)
...
-   [Render the <Scripts /> component](https://tanstack.com/router/latest/docs/framework/solid/guide/document-head-management#scripts)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/document-head-management#scripts-)
...
](https://tanstack.com/router/latest/docs/framework/solid/guide/document-head-management#example)
