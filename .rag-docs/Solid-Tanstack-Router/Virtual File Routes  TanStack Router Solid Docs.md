...
](https://tanstack.com/router/latest/docs/framework/solid/routing/virtual-file-routes#configuration)
...
](https://tanstack.com/router/latest/docs/framework/solid/routing/virtual-file-routes#configuration-via-the-tanstackrouter-plugin)
...
](https://tanstack.com/router/latest/docs/framework/solid/routing/virtual-file-routes#creating-virtual-file-routes)
...
](https://tanstack.com/router/latest/docs/framework/solid/routing/virtual-file-routes#virtual-root-route)
...
](https://tanstack.com/router/latest/docs/framework/solid/routing/virtual-file-routes#virtual-route)
...
](https://tanstack.com/router/latest/docs/framework/solid/routing/virtual-file-routes#virtual-index-route)
...
](https://tanstack.com/router/latest/docs/framework/solid/routing/virtual-file-routes#virtual-pathless-route)
...
](https://tanstack.com/router/latest/docs/framework/solid/routing/virtual-file-routes#physical-virtual-routes)
...
](https://tanstack.com/router/latest/docs/framework/solid/routing/virtual-file-routes#virtual-routes-inside-of-tanstack-router-file-based-routing)
...
](https://tanstack.com/router/latest/docs/framework/solid/routing/virtual-file-routes#inception)
...
](https://tanstack.com/router/latest/docs/framework/solid/routing/virtual-file-routes#configuration-via-the-tanstack-router-cli)
