...
](https://tanstack.com/router/latest/docs/eslint/create-route-property-order#rule-details)
...
](https://tanstack.com/router/latest/docs/eslint/create-route-property-order#attributes)
