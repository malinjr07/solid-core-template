...
](https://tanstack.com/form/latest/docs/framework/solid/guides/arrays#basic-usage)

To use an array, you can use field.state.value on an array value in conjunction with [Index from solid-js](https://www.solidjs.com/tutorial/flow_index):
...
](https://tanstack.com/form/latest/docs/framework/solid/guides/arrays#full-example)
