...
](https://tanstack.com/form/latest/docs/reference/type-aliases/DeepValue#type-alias-deepvaluetvalue-taccessor)
...
](https://tanstack.com/form/latest/docs/reference/type-aliases/DeepValue#type-parameters)[

### TValue

](https://tanstack.com/form/latest/docs/reference/type-aliases/DeepValue#tvalue)
...
](https://tanstack.com/form/latest/docs/reference/type-aliases/DeepValue#taccessor)

TAccessor

[Edit on GitHub](https://github.com/tanstack/form/edit/main/docs/reference/type-aliases/DeepValue.md)

### On this page

-   [Type Alias: DeepValue](https://tanstack.com/form/latest/docs/reference/type-aliases/DeepValue#type-alias-deepvaluetvalue-taccessor "type-alias-deepvaluetvalue-taccessor")
-   [Type Parameters](https://tanstack.com/form/latest/docs/reference/type-aliases/DeepValue#type-parameters "type-parameters")
-   [TValue](https://tanstack.com/form/latest/docs/reference/type-aliases/DeepValue#tvalue "tvalue")
-   [TAccessor](https://tanstack.com/form/latest/docs/reference/type-aliases/DeepValue#taccessor "taccessor")
