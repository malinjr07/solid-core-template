> Please thoroughly read the [Important Defaults](https://tanstack.com/query/latest/docs/framework/solid/guides/important-defaults) before reading this guide

[

## Basic Example

](https://tanstack.com/query/latest/docs/framework/solid/guides/caching#basic-example)
