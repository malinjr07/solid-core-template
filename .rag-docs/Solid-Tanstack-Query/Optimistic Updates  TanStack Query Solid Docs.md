Solid Query provides two ways to optimistically update your UI before a mutation has completed. You can either use the onMutate option to update your cache directly, or leverage the returned variables to update your UI from the useMutation result.

[

## Via the UI

](https://tanstack.com/query/latest/docs/framework/solid/guides/optimistic-updates#via-the-ui)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/optimistic-updates#if-the-mutation-and-the-query-dont-live-in-the-same-component)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/optimistic-updates#via-the-cache)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/optimistic-updates#updating-a-list-of-todos-when-adding-a-new-todo)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/optimistic-updates#updating-a-single-todo)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/optimistic-updates#when-to-use-what)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/optimistic-updates#further-reading)
