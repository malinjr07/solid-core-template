...
](https://tanstack.com/query/latest/docs/framework/solid/guides/prefetching#prefetchquery--prefetchinfinitequery)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/prefetching#prefetch-in-event-handlers)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/prefetching#prefetch-in-components)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/prefetching#dependent-queries--code-splitting)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/prefetching#router-integration)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/prefetching#manually-priming-a-query)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/prefetching#further-reading)
