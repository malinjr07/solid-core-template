...
](https://tanstack.com/query/latest/docs/framework/solid/guides/mutations#resetting-mutation-state)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/mutations#mutation-side-effects)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/mutations#consecutive-mutations)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/mutations#promises)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/mutations#retry)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/mutations#persist-mutations)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/mutations#persisting-offline-mutations)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/mutations#mutation-scopes)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/mutations#further-reading)

For more information about mutations, have a look at [TkDodo's article on Mastering Mutations in Solid Query](https://tkdodo.eu/blog/mastering-mutations-in-react-query).