Application performance is a broad and complex area and while Solid Query can't make your APIs faster, there are still things to be mindful about in how you use Solid Query to ensure the best performance.
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/request-waterfalls#what-is-a-request-waterfall)
...
## Request Waterfalls & Solid Query

](https://tanstack.com/query/latest/docs/framework/solid/guides/request-waterfalls#request-waterfalls--solid-query)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/request-waterfalls#single-component-waterfalls--serial-queries)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/request-waterfalls#nested-component-waterfalls)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/request-waterfalls#code-splitting)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/request-waterfalls#summary-and-takeaways)
...
In the next guide, we'll look at more ways to flatten waterfalls, by leveraging [Prefetching & Router Integration](https://tanstack.com/query/latest/docs/framework/solid/guides/prefetching).