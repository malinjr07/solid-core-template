...
](https://tanstack.com/query/latest/docs/framework/solid/plugins/createPersister#installation)
...
](https://tanstack.com/query/latest/docs/framework/solid/plugins/createPersister#usage)
...
](https://tanstack.com/query/latest/docs/framework/solid/plugins/createPersister#adapted-defaults)
...
](https://tanstack.com/query/latest/docs/framework/solid/plugins/createPersister#additional-utilities)
...
](https://tanstack.com/query/latest/docs/framework/solid/plugins/createPersister#persistquerybykeyquerykey-querykey-queryclient-queryclient-promisevoid)
...
](https://tanstack.com/query/latest/docs/framework/solid/plugins/createPersister#retrievequerytqueryhash-string-promiset--undefined)
...
](https://tanstack.com/query/latest/docs/framework/solid/plugins/createPersister#persistergc-promisevoid)
...
](https://tanstack.com/query/latest/docs/framework/solid/plugins/createPersister#restorequeriesqueryclient-queryclient-filters-promisevoid)
...
](https://tanstack.com/query/latest/docs/framework/solid/plugins/createPersister#api)[

### experimental\_createQueryPersister

](https://tanstack.com/query/latest/docs/framework/solid/plugins/createPersister#experimental_createquerypersister)
...
](https://tanstack.com/query/latest/docs/framework/solid/plugins/createPersister#options)
