...
](https://tanstack.com/query/latest/docs/framework/solid/guides/query-retries#retry-delay)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/query-retries#background-retry-behavior)
