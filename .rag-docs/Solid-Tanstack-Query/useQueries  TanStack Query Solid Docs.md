...
](https://tanstack.com/query/latest/docs/framework/solid/reference/useQueries#combine)
...
](https://tanstack.com/query/latest/docs/framework/solid/reference/useQueries#memoization)
