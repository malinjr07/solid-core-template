...
](https://tanstack.com/query/latest/docs/framework/solid/guides/initial-query-data#using-initialdata-to-prepopulate-a-query)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/initial-query-data#staletime-and-initialdataupdatedat)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/initial-query-data#initial-data-function)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/initial-query-data#initial-data-from-cache)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/initial-query-data#initial-data-from-the-cache-with-initialdataupdatedat)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/initial-query-data#conditional-initial-data-from-cache)
...
](https://tanstack.com/query/latest/docs/framework/solid/guides/initial-query-data#further-reading)
